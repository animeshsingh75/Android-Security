...
import com.example.androidsecurity.Constants.ANDROID_KEY_STORE
import com.example.androidsecurity.Constants.SECRET
...
class CryptoManager {
    ...
    fun decrypt(inputStream: InputStream): ByteArray {
        return inputStream.use {
            ...
            it.read(iv)
            val encryptedBytesSizes = it.read()
            val encryptedBytes = ByteArray(encryptedBytesSizes)
